    ...
    {/* <header className="bg-red-600"> */}
      <div className="container mx-auto flex justify-between">
        <nav className="flex">
          ...
          className="inflex-flex items-center py-6 px-3 mr-4 text-purple-200 hover:text-green-500 text-4xl font-bold cursive tracking-widest">
            Scott
          </NavLink>
          <NavLink 
            to="/post" 
        ...
        {/* Can change background color with  bgColor="#000" */}
